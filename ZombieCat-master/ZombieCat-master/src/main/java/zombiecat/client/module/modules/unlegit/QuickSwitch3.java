...
public class QuickSwitch3 extends Module {
   ...
   public QuickSwitch3() {
      super("QuickSwitch3", ModuleCategory.unlegit);
   ...
   public void a(TickEvent.RenderTickEvent ev) {
      if (ev.phase == TickEvent.Phase.END && Utils.Player.isPlayerInGame()) {
         ...
         mc.fontRendererObj.drawStringWithShadow("Preset:3 " +"Slot2:" + s2.getValue() + " Slot3:" + s3.getValue() + " Slot4:" + s4.getValue() + " Delay:" + delay.getValue(), 10, 10, 0xFFFFFF);
      }
   }
